    ...
    <div className="container-z py-10">
      ...
      <div className="mt-6 grid gap-10 lg:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-3 text-sm leading-relaxed text-muted-foreground">{product.shortDescription[lang]}</p>
          ...
          <div className="mt-7 flex flex-wrap items-center gap-3">
            <div className="flex items-center border border-border">
              <button type="button" onClick={() => setQuantity((q) => Math.max(1, q - 1))} className="px-4 py-3" aria-label="-">
                <Minus className="h-3.5 w-3.5" strokeWidth={1.4} />
              </button>
              <span className="min-w-10 text-center text-sm">{quantity}</span>
              <button type="button" onClick={() => setQuantity((q) => q + 1)} className="px-4 py-3" aria-label="+">
            ...
            >
              {added ? <Check className="h-4 w-4" strokeWidth={1.4} /> : <ShoppingBag className="h-4 w-4" strokeWidth={1.4} />}
          ...
          <div className="mt-8 border-t border-border pt-6">
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">{product.description[lang]}</p>
          </div>
        </div>
      </div>
